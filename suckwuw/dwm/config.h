...
/*My Colors */
static const char col_golden_light[]   = "#FFD700"; // Light golden color
static const char col_golden_dark[]    = "#FFA500"; // Dark golden color
static const char col_blue1[]          = "#1f2241"; // Retaining the original blue color
static const char col_blue2[]          = "#3e4482"; // Retaining the original blue color
static const char col_black[]          = "#000000"; // Black color
